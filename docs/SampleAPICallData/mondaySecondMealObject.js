const object = {
  ...
  servings: 5,
  imageURL: "https://spoonacular.com/recipeImages/472111-556x370.jpg",
  summaryDescription:
  ...
  steps: {
    1: "Preheat the oven to 250 degrees F and line a baking tray with baking paper.",
    2: "Combine all the ingredients, then spread evenly on a tray.",
    3: "Bake for 15-20 minutes, until golden, turning halfway through the cooking time. I like to bake mine until quite dark—the darker it is, the crunchier.",
    4: "Remove from the oven and allow to cool, then eat while it's still crispy.",
  },
};
